...
QT_MOC_LITERAL(1, 8, 19), // "eventsUpdatedSignal"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "guiUSER\0eventsUpdatedSignal\0"
};
...
void guiUSER::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (guiUSER::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&guiUSER::eventsUpdatedSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void guiUSER::eventsUpdatedSignal()
{
